...
- Según la forma en la que operan:
  - __Declarativos__: este tipo de lenguaje tiene poco uso, salvo el SQL. 
  Indicamos el resultado a obtener sin especificar los pasos.
...
- Tipos de __lenguajes imperativos__:
  ...
  - Multiparadigma: C++, Javascript.  Pueden trabajar de varias formas.
...
- Tipos de lenguajes según nivel de abstracción: 
  - Bajo nivel: ensamblador. Hay que indicar cualquier operación que vayamos a hacer.
  - Medio nivel: C
  - Alto nivel: C++, Java
...
- Campo de aplicación. Se refiere al tipo de programa que vamos a hacer.
- Experiencia previa
